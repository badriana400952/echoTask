...
function viewElement() {
    ...
    for (let index = 0; index < blogr.length; index++) {
        ...
        <div class="card my-4 border-none shadow" style="width: 23rem;">
                        <img src="${blogr[index].image}" alt="badro" class="card-img-top">
                        <div class="card-body">
                            <h5 class="text-dark-emphasis ">${blogr[index].nama}</h5>
                            <p class="card-text">Dari ${blogr[index].start} </p>
                            <p class="card-text">Sampai  ${blogr[index].endd} </p>
                            <p class="card-text">Durasi ${blogr[index].bulan} Bulan atau ${blogr[index].hari} hari </p>
                            <p class="card-text">${blogr[index].deskripsi}</p>
                                <div class="iconss">
                                ...
                                <div class="mt-4 d-flex justify-content-center gap-3" >
                                    <button class="btn btn-dark"><a class="text-decoration-none text-light px-5 " href="detail">Detail</a> </button>
